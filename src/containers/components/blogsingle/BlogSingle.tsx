...
const BlogSingle: React.FC<BlogSingleProps> = props => {
  const { maxWidth, open, onClose, title, doc, image1, author, authorName, date } = props;
  return (
    <>
          ...
          <div className="tp-blog-content clearfix">
            <div className="post">
              ...
              <ul className="entry-meta">
                <li>
                  <img src={author} alt="" /> <Link href="/">By {authorName}</Link>
                </li>
                <li>
                  <Link href="/">
              ...
              <p>
                ...
                Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using &apos;Content here, content here&apos;, making it

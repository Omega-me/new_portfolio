...
const PortfolioSingle: React.FC<PortfolioSingleProps> = props => {
  const { maxWidth, open, onClose, title, doc, image1, image2, image3, authorName, videosId, value, date } = props;
  return (
    <>
              ...
              <div className="col-lg-12">
                ...
                <div className="tp-p-details-section">
                  ...
                  <p>
                    ...
                    there isn&apos;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat
                  ...
                  <p>
                    ...
                    reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour,sure there isn&apos;t anything embarrassing
                ...
                <div className="tp-p-details-quote">
                  <p>
                    ...
                    predefined chunks as necessary net Essential book for you.{' '}
                  </p>
